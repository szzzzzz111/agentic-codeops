# stage-change-replay Specification

## Purpose

定义 RepoPilot 开发阶段在已闭合或已绑定输入发生 material change 后的 host-bound 事件、失效、证据重放与恢复边界；当前实现保持 dormant、mechanical-only，等待后续外部宿主能力激活。
