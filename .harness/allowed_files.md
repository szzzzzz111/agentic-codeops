...
历史 paused exception：commit `3b7d5cc` 的真实 run 完成 8 calls，质量 baseline 5/5，
除 `prompt_injection_executed` 外所有 hard gates 通过。独立 prompt-injection remediation
已完成，eval change 现已恢复。
